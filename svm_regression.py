...
if os.path.isfile(training_file):
    ...
    print clf.fit(data,demands)
    with open(training_file,'wb') as f:
        pickle.dump(clf,f,protocol=2)
        
score = clf.score(data,demands)
print "Score: ",score
...
plt.plot(range(len(demands_future)),clf.predict(rest_data),c='r',label='predicted')
plt.legend(loc=1)
plt.title('Predicting '+'score: '+str(clf.score(rest_data,demands_future)))