...
beta_1 = 0.853969791317
beta_2 = 0.95007826035
epsilon=9.39138231411e-08
learning_rate_init =0.00109700803288
alpha = 9.10780858215e-05
...
write = consts + [score,rest_score]
write = ' |'.join(map(str,write))

print "Consts:",write
print "Score: ",score
print "Rest score:",rest_score
result_file = 'nn_resultsH.txt'
print "Output file:",result_file
with open(result_file,'a') as f:
    f.write(repr(neural).replace('\n', ' ').replace('\r', '')+'\n')
    f.write(write+'\n')  
'''
plt.figure()
